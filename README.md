...
<span style="display: inline-block; margin: 8px 4px 0 4px;">
  <a href="https://crates.io/crates/peek">
    <img src="https://img.shields.io/crates/v/peek?style=for-the-badge&color=70fb9e" alt="Crates.io Version">
  </a>
</span>
<span style="display: inline-block; margin: 8px 4px 0 4px;">
...
chmod +x peek
sudo mv peek /usr/local/bin/peek
```
...
Want to hack on peek or add features?
